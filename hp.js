...
var Utopia = {
    ...
    loadConfig: function() {
        ...
        GLOBAL.config.socket = require('./config/socket.js');
    },
    ...
    requireLibs: function() {
        ...
        //GLOBAL.SocketService = require('./utopia/service/Socket.js');
        GLOBAL.AjaxService = require('./utopia/service/Ajax.js');
    ...
    initServices: function() {
        ...
        GLOBAL.WebServer.init(this.hookManager, function(httpServer) {
            ...
            // Subseq init the socket service
            //me.initSocketService(httpServer, me.hookManager);

            // Subseq init the ajax service
            me.initAjaxService(httpServer, me.hookManager);
        });
    },


    /**
     * Starts the socket.io based socket service
     * @param {Object} httpServer Connect HTTP server reference
     * @param {Utopia.HookManager} hookManager Hook manager reference
     * @return void
     */
    initSocketService: function(httpServer, hookManager) {

        console.log('  * Starting socket service...');

        // Initialize the socket.io service with the express instance
        GLOBAL.SocketService.init(httpServer, hookManager);
    },


    /**
     * DISABLED. (socket.io-only)
     * Starts the Ajax based service
     * @param {Object} httpServer Connect HTTP server reference
     * @param {Utopia.HookManager} hookManager Hook manager reference
     * @return void
     */
    initAjaxService: function(httpServer, hookManager) {

        console.log('  * Starting AJAX service...');

        // Initialize the socket.io service with the express instance
        GLOBAL.AjaxService.init(httpServer, hookManager);
    }
};
